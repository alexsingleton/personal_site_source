...
params:
   address: University of Liverpool, Department of Geography and Planning, Gordon Stephenson Building,Liverpool, L69 7ZQ
...
Within a framework of Geographic Information Science, my research has extended a tradition of area classification in Geography. I have developed an empirically informed critique of the ways in which geodemographic methods can be refined for effective yet ethical use in public resource allocation applications. This research has developed from substantive interests in the investigation of the social, spatial and temporal dimensions of access inequalities in Higher Education. In addition to this core research agenda, I have also explored issues of digital exclusion, aspects of retail, school commuting behaviour, as well as the ways in which new mapping tools and techniques can be utilised in activities related to the public understanding of science. I am an advocate of open source data and software, and the majority of my research (and research led teaching) involve the use of open geocomputation with large administrative or crowd sourced datasets.
...
* 2012
    ...
    + Session Organiser: New approaches in quantitative social geography: new data, new meth- ods, new insights. Association of American Geographers Conference, New York.
* 2010
...
* 2009
    ...
    + Organising committee for the 2010 GIS Research UK Conference. London, University Col- lege London.
...
## Software
* gd (http://rpubs.com/alexsingleton/gd) - An R package for building, testing and visualisation of geodemo- graphic classification.
...
## Websites
I have developed and/or manage a range successful websites created as part of activities associated with research grants. These websites have wide ranging purposes, including pedagogic resource dissemination, public participation in GIS or impact generation. Many of these sites have captured a wide and international audience. For example, the worldnames (worldnames.publicprofler.org) website has recieved over 2 million unique users from 200 countries since August 30 2008.
