...
# External Review / Panel Experience
* University of Leeds: MOT Project (EPSRC), Advisory Panel (2015-16).
* Expert review board -  UKCRIC (UK Collaboratorium for Research on Infrastructure and Cities) Data and Analytics Facility for National Infrastructure (DAFNI) (2017 -).
* JISC - Geospatial Platform Evaluation (2017).
